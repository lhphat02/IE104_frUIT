...
const aboutUS = () => {
  return (
    <div className="mx-20">
      ...
      ></img>
      <div className="my-10">
        <div className="py-3 text-xl text-justify border-t-2 border-solid">
          NHÓM 5
        ...
        <div className="flex flex-col items-center justify-center">
          <img className="rounded-full" src="" alt="Lưu Huỳnh Phát"></img>
          <div>
            <p className="text-xl">Lưu Huỳnh Phát</p>
            <p>Vị trí</p>
            <p>tự sự</p>
        ...
        <div className="flex flex-col items-center justify-center">
          <img className="rounded-full" src="" alt="Hoàng Tuấn Anh"></img>
          <div>
            <p className="text-xl">Hoàng Tuấn Anh</p>
            <p>Vị trí</p>
            <p>tự sự</p>
