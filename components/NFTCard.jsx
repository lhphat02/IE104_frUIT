...
const NFTCard = ({ nft }) => {
  return (
    <Link href={{ pathname: '/nft-detail', query: nft }}>
      <div className="w-56 p-3 m-4 bg-white shadow-md cursor-pointer sm:w-full dark:bg-prim-black-3 rounded-2xl sm:my-2 sm:mx-2">
        <div className="relative w-full overflow-hidden h-52 sm:h-36 xs:h-56 rounded-xl">
          <Image
            src={nft.image}
            objectFit="cover"
            layout="fill"
