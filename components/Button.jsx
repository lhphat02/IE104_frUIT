...
const Button = ({ classStyles, btnName, handleClick, cancelBg }) => (
  <button
    ...
    className={
      cancelBg
        ? `text-sm minlg:text-lg px-6 py-2 minlg:px-8 font-poppins font-semibold text-prim-pink dark:text-prim-blue border-2 dark:border-prim-blue border-prim-pink shadow-md ${classStyles}`
